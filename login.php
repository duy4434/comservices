...
<div class="login-box">
  <div class="login-logo">
    ...
    <a href="#"><b>ระบบเเจ้งซ่อม</b></a>
    <i class="fas fa-wrench nav-icon"></i>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">ระบบเเจ้งซ่อม</p>
      ...
      <form action="" method="post">
        ...
        <div class="row">
          <!-- /.col -->
          <div class="col-12">
               <button type="submit" name="submit" class="btn btn-primary btn-block btn-flat my-2">Login</button>
          </div>
